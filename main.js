...
3) Сделать реализацию внутри CSS селектора
4) Отрисовывать слайдер на стороне JS, копируя объекты
5) Добавить поддержку клавиатуры, тачскрина и адаптировать доступность под людей с особенностями и ограничениями здоровья
*/
